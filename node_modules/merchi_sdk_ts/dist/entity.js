                ...
                for (var _b = __values(_this.propertiesMap.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    if (propertyInfo.currentValue !== undefined) {
                        if (propertyInfo.arrayType) {
                            propertyInfo.currentValue.map(function (v) { return v.cleanDirty(); });
                        }
        ...
        this.markDirty = function (property, newValue) {
            ...
            while (openSet.length > 0) {
                ...
                if (!closedSet.has(current)) {
                    ...
                    try {
                        for (var _b = (e_6 = void 0, __values(current.backObjects)), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var child = _c.value;
                            openSet.push(child);
                        }
                    }
        ...
        properties.forEach(function (attributeName) {
            ...
            if (type === Object) {
                ...
                var err = 'Bad attribute type ' +
                    "".concat(resource, ".").concat(attributeName, ": ").concat(type);
                throw new Error(err);
            }
    ...
    Entity.list = function (options) {
        ...
        if (options) {
            ...
            if (options.turnaroundTimeDays !== undefined) {
                fetchOptions.query.push(['turnaround_time_days', options.turnaroundTimeDays.toString()]);
            }
            ...
            if (options.excludeJobs !== undefined) {
                fetchOptions.query.push(['exclude_jobs', options.excludeJobs.join(',')]);
            }
