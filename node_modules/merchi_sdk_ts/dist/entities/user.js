...
import { Role, DOMAIN_MANAGERS, MANAGEMENT_TEAM, BUSINESS_ACCOUNTS, ROLES_RANK } from '../constants/roles.js';
...
var User = /** @class */ (function (_super) {
    ...
    function User() {
        ...
        _this.roleInDomain = function (domain) {
            ...
            if (matchingEnrolledDomains.length > 1) {
                var highestRoleRank = Math.max.apply(Math, __spreadArray([], __read(matchingEnrolledDomains.map(function (ed) { return ROLES_RANK.findIndex(function (e) { return e === ed.role; }); })), false));
    ...
    User.prototype.companies = function () {
        if (this.userCompanies === undefined) {
            var err = 'userCompanies is undefined, did you forget to embed it?';
            throw new Error(err);
        }
        return this.userCompanies.map(function (userCompany) {
            if (userCompany.company === undefined) {
                var err = 'userCompany.company is undefined, did you forget to embed it?';
                throw new Error(err);
            }
    ...
    User.prototype.hasSystemRole = function (role) {
        if (this.systemRoles === undefined) {
            var err = 'systemRoles is undefined, did you forget to embed it?';
            throw new Error(err);
        }
        return some(this.systemRoles.map(function (systemRole) { return systemRole.role === role; }));
    };
    User.prototype.hasRoles = function (roles, combinationMethod) {
        if (combinationMethod === void 0) { combinationMethod = some; }
        if (this.enrolledDomains === undefined) {
            var err = 'enrolledDomains is undefined, did you forget to embed it?';
            throw new Error(err);
        }
        var allRoles = this.enrolledDomains.map(function (enrolledDomain) { return enrolledDomain.getRole(); });
        allRoles.push(Role.PUBLIC);
        return combinationMethod(roles.map(function (role) { return allRoles.indexOf(role) !== -1; }));
    };
    ...
    __decorate([
        ...
        __metadata("design:type", Array)
    ], User.prototype, "registeredUnderDomains", void 0);
    __decorate([
    ...
    __decorate([
        User.property({ type: String }),
        __metadata("design:type", String)
    ], User.prototype, "internalUseNotes", void 0);
    __decorate([
        User.property({ type: String }),
        __metadata("design:type", String)
    ...
    __decorate([
        User.property({ type: String }),
        __metadata("design:type", String)
    ], User.prototype, "internalUseAiContext", void 0);
    __decorate([
        User.property({ type: String }),
        __metadata("design:type", String)
    ], User.prototype, "aiContext", void 0);
    __decorate([
        User.property(),
        __metadata("design:type", String)
    ], User.prototype, "callToActions", void 0);
    __decorate([
        User.property(),
        __metadata("design:type", Array)
    ], User.prototype, "callToActionDetails", void 0);
    __decorate([
        User.property({ type: String }),
        __metadata("design:type", Object)
    ...
    __decorate([
        User.property(),
        __metadata("design:type", Boolean)
    ], User.prototype, "enableStoreNotifications", void 0);
    __decorate([
        User.property(),
        __metadata("design:type", Boolean)
    ], User.prototype, "isAdminOfSubscribedCompany", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Array)
    ], User.prototype, "companiesNeedStripe", void 0);
    __decorate([
    ...
    __decorate([
        User.property({ arrayType: 'Domain' }),
        __metadata("design:type", Array)
    ], User.prototype, "accessibleDomainsAsClient", void 0);
    return User;
}(Entity));
export { User };
