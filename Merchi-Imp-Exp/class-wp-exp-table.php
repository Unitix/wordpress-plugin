...
class Merchi_Export_Product_List extends WP_List_Table {
    // Constructor
...
// Usage
function woo_product_list_table_page() {
    ?>
    <div class="wrap">
        <h2>Export Products</h2>
        <form method="post" action="">
            <?php
            $my_products_list = new Merchi_Export_Product_List();
...
function woo_product_list_table_menu() {
    add_menu_page( 'Merchi Export Table', 'Merchi Export Table', 'manage_options', 'woo_products_list', 'woo_product_list_table_page' );
}
add_action( 'admin_menu', 'woo_product_list_table_menu' );